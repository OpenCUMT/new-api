...
func Register(c *gin.Context) {
	...
	if err := common.ValidateRestrictedRegisterEmail(user.Email); err != nil {
	...
	if common.EmailVerificationEnabled || common.RestrictedRegisterEmailVerificationRequired() {
...
func EmailBind(c *gin.Context) {
	...
	code := c.Query("code")
	if err := common.ValidateRestrictedRegisterEmail(email); err != nil {
		common.ApiError(c, err)
		return
	}
